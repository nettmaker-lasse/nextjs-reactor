	...
	return (
		<div className="bg-gray-900">
			<main>
				...
				{/* Logo cloud */}
				<div className="px-6 mx-auto mt-8 max-w-7xl sm:mt-16 lg:px-8">
				...
				<div className="px-6 mx-auto mt-32 max-w-7xl sm:mt-56 lg:px-8">
					...
					<dl className="grid max-w-2xl grid-cols-1 mx-auto mt-16 text-white gap-x-8 gap-y-10 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
						{stats.map((stat) => (
							<div
								key={stat.id}
								className="flex flex-col pl-6 border-l gap-y-3 border-white/10"
							>
				...
				{/* CTA section */}
				<div className="relative px-6 py-32 mt-32 isolate sm:mt-56 sm:py-40 lg:px-8">
					<svg
						className="absolute inset-0 -z-10 h-full w-full stroke-white/10 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
						aria-hidden="true"
					>
